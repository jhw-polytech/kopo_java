...
public class BoardUtil {
	...
	public void update(int num) {
		...
		Board.users[num-1] = new Post(title,users);
	...
	public void insert() {
		...
		Board.users[Board.rows] = new Post(title,users);
	...
	public void select(int num) {
		...
		System.out.println((num)+"\t"+Board.users[num-1].getTitle()+"\t"
				+Board.users[num-1].getWriter()+"\t"+Board.users[num-1].getDate());
	...
	public void select() {
		...
		for(int i=0;i<Board.rows;i++) {
			System.out.println((i+1)+"\t"+Board.users[i].getTitle()+"\t"
					+Board.users[i].getWriter()+"\t"+Board.users[i].getDate());
		}
	}
}
